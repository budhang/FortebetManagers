    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisterOfficeItems", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                name: "RegisterElectronics",
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    DatePurchased = table.Column<DateTime>(nullable: false),
                    ElectronicsID = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisterElectronics", x => x.ID);
                    table.ForeignKey(
                        name: "FK_RegisterElectronics_Electronics_ElectronicsID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegisterElectronics_ElectronicsID",
                table: "RegisterElectronics",
